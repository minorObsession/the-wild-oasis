...
function Pagination({ numResults }) {
  ...
  function nextPage() {
    const nextP = currentPage === numPages ? currentPage : currentPage + 1;
    searchParams.set("page", nextP);
    setSearchParams(searchParams);
  }

  function prevPage() {
    const prevP = currentPage === 1 ? currentPage : currentPage - 1;
    searchParams.set("page", prevP);
    setSearchParams(searchParams);
  }
